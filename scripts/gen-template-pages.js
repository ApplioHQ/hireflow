...
const T = [
  ...
  { id:'tech', name:'Tech', cat:'Technology', kw:'tech resume template',
    tagline:'A modern engineering layout with a clean skills band.',
    bestFor:['Developers, IT, and DevOps','Product and technical roles','Anyone with a strong skills stack to feature'],
    why:'A dedicated skills area plus clean sections help technical keywords surface for ATS matching.' },
